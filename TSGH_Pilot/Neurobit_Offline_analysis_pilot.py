...
if __name__== '__main__':
    Neurobit_Lib_pilot.Release_ver = "Release2.02_pilot"
    main_path = "E:\\Result\\"+ Neurobit_Lib_pilot.Release_ver +"\\Result"
    Subject.DB_path = "E:\\Result\\"+ Neurobit_Lib_pilot.Release_ver
...
# =============================================================================
    ...
    ACT_dx_pd.to_excel(os.path.join(Subject.save_path,Neurobit_Lib_pilot.Release_ver+'_ACT_dx.xlsx'))   
    
    Subject.GetGaze9_Save()
    Gaze9_dx_pd = pd.DataFrame(Subject.Gaze9_dx) 
    Gaze9_dx_pd.to_excel(os.path.join(Subject.save_path,Neurobit_Lib_pilot.Release_ver+'_Gaze9_dx.xlsx'))   
    
    Subject.GetCUT_Save()
    CUT_dx_pd = pd.DataFrame(Subject.CUT_dx) 
    CUT_dx_pd.to_excel(os.path.join(Subject.save_path,Neurobit_Lib_pilot.Release_ver+'_CUT_dx.xlsx'))   
